...
3. The stored parameter vector is ordered $(\pi',\beta)'`. At summary time, the code reconstructs every observation's full moment row by scaling $\tilde W_i$ with $v_i$ and appending $v_i(Y_i-D_i\beta)$.
