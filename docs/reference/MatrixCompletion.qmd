...
6. The displayed objective is evaluated after the new low-rank matrix. The RMSE history, however, is based on residuals measured immediately before the singular-value update. Relative objective change is checked from the second iteration onward.
