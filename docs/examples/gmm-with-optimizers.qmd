...
This page constructs GMM objectives explicitly with `Optimizers` to show the scalar-objective and residual interfaces. For ordinary moment estimation, use the [first-class GMM estimator](gmm.qmd), which handles weighting, convergence, and covariance together.
