...
The common coefficient interpretation is multiplicative on the hazard. If a coefficient is $eta_j$, then $exp(\beta_j)$ is a hazard ratio.
...
for profile, label in zip(profiles, labels):
    ...
    ax.plot(grid, weibull.survival(xx, grid), label=label)
