...
Survival models describe event timing through a hazard rate: the instantaneous event risk among units still at risk. `crabbymetrics` includes four survival estimators:
...
The survival API exposes the same layered contract as the MLE estimators:
