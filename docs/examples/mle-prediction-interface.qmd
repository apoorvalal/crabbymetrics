...
subtitle: "Latent indices, probabilities, means, and labels"
execute:
  echo: true
  warning: false
  message: false
...
This vignette documents the prediction contract used by the nonlinear MLE-style estimators in v0.9.0.

## The contract

For the estimators where prediction makes sense, the public surface is layered:
