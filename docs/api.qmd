...
model = cm.PartiallyLinearDML(penalty=np.array([0.0, 0.05, 0.2, 1.0]), cv=5, n_folds=5, seed=1)
model.fit(y, d, x)
...
model = cm.AIPW(penalty=np.array([0.0, 0.05, 0.2, 1.0]), cv=5, n_folds=5, seed=1)
model.fit(y, d, x)
