...
The synthetic-control comparator receives a 10,000-iteration budget for this
72-donor problem. Its former 800-iteration budget exhausted the solver; v0.9
correctly raises instead of exposing that unfinished fit. The data, objective,
and convergence tolerance are unchanged.
...
sc = SyntheticControl(max_iterations=10000)
